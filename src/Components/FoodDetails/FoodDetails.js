            ...
            <div className="row">
                <div className="col-md-6 pr-md-4">
                    ...
                    {/* <div className="more-images mt-5 ">
                        {currentFood.img.map((img ,index) => <img onClick={() => setSelectedBigImg(currentFood.img)} className={currentFood.img === selectedBigImg ? "mr-4 small-img active-small-img" : "mr-4 small-img"} height="150px" src={img} alt=""/>)}
                    </div> */}
                </div>
